...
// Validate indicates if the fields are valid
...
// IsZero determines if the search arguments have values or not
func (a SearchParams) IsZero() bool {
	return a.Description == nil && a.Priority == nil && a.IsDone == nil
}
